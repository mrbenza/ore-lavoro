...
**NON tocca:** file `.html`, `AGENTS.md`, `SHEET_SCHEMA.md`, file di test
...
**NON tocca:** file `.gs`, `AGENTS.md`, `SHEET_SCHEMA.md`
...
**NON tocca:** file `.gs`, file `.html`, `AGENTS.md`
...
**Compiti:**
- Aggiornare `AGENTS.md` dopo ogni modifica rilevante degli altri agenti
...
4. **Documentazione condizionale** — Il `code-review-docs` viene chiamato come ultimo step **solo se** le modifiche sono rilevanti per README, AGENTS.md o roadmap. Per fix minori può essere omesso.
